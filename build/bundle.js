    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file$1, 11, 2, 183);
    			add_location(p0, file$1, 13, 2, 211);
    			add_location(p1, file$1, 16, 2, 278);
    			attr_dev(a0, "href", "/blog");
    			add_location(a0, file$1, 22, 4, 444);
    			add_location(div, file$1, 20, 2, 419);
    			attr_dev(h21, "class", "svelte-hgohpc");
    			add_location(h21, file$1, 26, 8, 494);
    			add_location(li0, file$1, 26, 4, 490);
    			attr_dev(a1, "href", "/modes");
    			add_location(a1, file$1, 28, 10, 531);
    			attr_dev(li1, "class", "svelte-hgohpc");
    			add_location(li1, file$1, 28, 6, 527);
    			attr_dev(a2, "href", "/2048");
    			add_location(a2, file$1, 29, 10, 589);
    			attr_dev(li2, "class", "svelte-hgohpc");
    			add_location(li2, file$1, 29, 6, 585);
    			attr_dev(a3, "href", "/sequencer");
    			add_location(a3, file$1, 30, 10, 635);
    			attr_dev(li3, "class", "svelte-hgohpc");
    			add_location(li3, file$1, 30, 6, 631);
    			attr_dev(a4, "href", "https://iso-note.herokuapp.com/");
    			add_location(a4, file$1, 32, 8, 694);
    			attr_dev(li4, "class", "svelte-hgohpc");
    			add_location(li4, file$1, 31, 6, 681);
    			attr_dev(a5, "href", "/magiclamp");
    			add_location(a5, file$1, 34, 10, 788);
    			attr_dev(li5, "class", "svelte-hgohpc");
    			add_location(li5, file$1, 34, 6, 784);
    			attr_dev(a6, "href", "https://vespertine-rhythms.herokuapp.com/");
    			add_location(a6, file$1, 36, 8, 850);
    			attr_dev(li6, "class", "svelte-hgohpc");
    			add_location(li6, file$1, 35, 6, 837);
    			attr_dev(ul0, "class", "svelte-hgohpc");
    			add_location(ul0, file$1, 27, 4, 516);
    			attr_dev(h22, "class", "svelte-hgohpc");
    			add_location(h22, file$1, 40, 8, 952);
    			add_location(li7, file$1, 40, 4, 948);
    			attr_dev(a7, "href", "/grammar");
    			add_location(a7, file$1, 42, 10, 996);
    			attr_dev(li8, "class", "svelte-hgohpc");
    			add_location(li8, file$1, 42, 6, 992);
    			attr_dev(a8, "href", "http://tilde.learning-gardens.co/~freda/");
    			add_location(a8, file$1, 43, 10, 1052);
    			attr_dev(li9, "class", "svelte-hgohpc");
    			add_location(li9, file$1, 43, 6, 1048);
    			attr_dev(ul1, "class", "svelte-hgohpc");
    			add_location(ul1, file$1, 41, 4, 981);
    			attr_dev(h23, "class", "svelte-hgohpc");
    			add_location(h23, file$1, 46, 8, 1142);
    			add_location(li10, file$1, 46, 4, 1138);
    			attr_dev(a9, "href", "/2017");
    			add_location(a9, file$1, 48, 10, 1183);
    			attr_dev(li11, "class", "svelte-hgohpc");
    			add_location(li11, file$1, 48, 6, 1179);
    			attr_dev(a10, "href", "/2016");
    			add_location(a10, file$1, 49, 10, 1223);
    			attr_dev(li12, "class", "svelte-hgohpc");
    			add_location(li12, file$1, 49, 6, 1219);
    			attr_dev(ul2, "class", "svelte-hgohpc");
    			add_location(ul2, file$1, 47, 4, 1168);
    			attr_dev(ol, "class", "svelte-hgohpc");
    			add_location(ol, file$1, 25, 2, 481);
